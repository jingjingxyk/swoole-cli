...
-DBZIP2_LIBRARY="%BZIP2_PREFIX%\lib\libbz2.lib" ^
...
-DCMAKE_C_FLAGS="/MT /O2 /W3 /DNDEBUG /DLZMA_API_STATIC /DZSTDLIB_STATIC_API /DZSTD_DLL_EXPORT=0 /DZSTD_DLL_IMPORT=0 " ^
-DCMAKE_C_FLAGS_RELEASE="/MT /O2 /W3 /DNDEBUG" ^
-DCMAKE_EXE_LINKER_FLAGS="/VERBOSE:LIB" ^
-DCMAKE_VERBOSE_MAKEFILE=ON

rem -DCMAKE_CXX_FLAGS="/DLZMA_API_STATIC /DZSTDLIB_STATIC_API  /DZSTD_DLL_EXPORT=0 /DZSTD_DLL_IMPORT=0 " ^
