...
7z.exe x -aoa -y   %__PROJECT__%\pool\lib\gettext-0.22.5.tar.gz

if  exist "%__PROJECT__%\thirdparty\gettext" rmdir /s /q "%__PROJECT__%\thirdparty\gettext"
mkdir "%__PROJECT__%\thirdparty\gettext"
