...

{
  ...
  docker rm swoole-cli-alpine-dev

  docker stop swoole-cli-debian-dev
  docker rm swoole-cli-debian-dev

  docker stop swoole-cli-rhel-dev
  docker rm swoole-cli-rhel-dev

  docker stop swoole-cli-ubuntu-dev
  docker rm swoole-cli-ubuntu-dev

  docker stop swoole-cli-builder
  docker rm swoole-cli-builder
