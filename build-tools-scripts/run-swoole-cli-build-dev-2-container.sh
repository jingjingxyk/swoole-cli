...
cd ${__DIR__}
default_image=docker.io/jingjingxyk/build-swoole-cli:build-dev-2-alpine-edge-20230207T100722Z

test -f swoole-cli-build-dev-2-container.txt && image=$(cat swoole-cli-build-dev-2-container.txt)
test -f swoole-cli-build-dev-2-container.txt || image=docker.io/jingjingxyk/build-swoole-cli:build-dev-2-alpine-edge-20230207T100722Z
