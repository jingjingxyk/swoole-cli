...
UNIX_DOWNLOAD_APP_RUNTIME() {
  ...
  local ARCH="$2"
  local APP_VERSION="$3"
  local APP_DOWNLOAD_URL="https://github.com/jingjingxyk/build-static-ttyd/releases/download/${VERSION}/${APP_NAME}-${APP_VERSION}-${OS}-${ARCH}.tar.xz"
...
WINDOWS_DOWNLOAD_APP_RUNTIME() {
  local APP_VERSION="$1"
  local ARCH="x64"
  local APP_DOWNLOAD_URL="https://github.com/jingjingxyk/build-static-ttyd/releases/download/${VERSION}/${APP_NAME}-${APP_VERSION}-cygwin-${ARCH}.zip"
